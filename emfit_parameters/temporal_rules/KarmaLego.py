...
class TIRP:
    ...
    def __init__(self, epsilon, max_distance, min_ver_supp, symbols=None, relations=None, k=1, vertical_support=None,
        ...
        :param indices_of_last_symbol_in_entities: list of indices of last element in symbols list in 
                                                   lexicographically ordered entities
...
class KarmaLego:
    ...
    def __init__(self, epsilon, max_distance, min_ver_supp):
        ...
        :param epsilon: maximum amount of time between two events that we 
                        consider it as the same time
        :param max_distance: maximum distance between 2 time intervals that
                             means first one still influences the second
        :param min_ver_supp: proportion (value between 0-1) defining threshold 
                             for accepting TIRP
        """
        self.epsilon = epsilon
        self.max_distance = max_distance
