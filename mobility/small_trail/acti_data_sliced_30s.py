...
filepath= os.path.abspath(r'D:/YangTrial/All/Yang_Data_30s.csv')
...
t1_1 = dt.datetime.strptime('2019-10-05 16:00:00', '%Y-%m-%d %H:%M:%S')
t1_2 = dt.datetime.strptime('2019-10-05 17:37:00', '%Y-%m-%d %H:%M:%S')

t2_1 = dt.datetime.strptime('2019-10-05 21:30:00', '%Y-%m-%d %H:%M:%S')
t2_2 = dt.datetime.strptime('2019-10-05 23:00:00', '%Y-%m-%d %H:%M:%S')

t3_1 = dt.datetime.strptime('2019-10-08 15:20:00', '%Y-%m-%d %H:%M:%S')
t3_2 = dt.datetime.strptime('2019-10-08 18:00:00', '%Y-%m-%d %H:%M:%S')

t4_1 = dt.datetime.strptime('2019-10-09 14:00:00', '%Y-%m-%d %H:%M:%S')
t4_2 = dt.datetime.strptime('2019-10-09 18:00:00', '%Y-%m-%d %H:%M:%S')

t5_1 = dt.datetime.strptime('2019-10-11 11:05:00', '%Y-%m-%d %H:%M:%S')
t5_2 = dt.datetime.strptime('2019-10-11 14:00:00', '%Y-%m-%d %H:%M:%S')

t6_1 = dt.datetime.strptime('2019-10-11 14:55:00', '%Y-%m-%d %H:%M:%S')
t6_2 = dt.datetime.strptime('2019-10-11 18:00:00', '%Y-%m-%d %H:%M:%S')

t7_1 = dt.datetime.strptime('2019-10-14 10:30:00', '%Y-%m-%d %H:%M:%S')
t7_2 = dt.datetime.strptime('2019-10-14 11:00:00', '%Y-%m-%d %H:%M:%S')

t8_1 = dt.datetime.strptime('2019-10-14 11:40:00', '%Y-%m-%d %H:%M:%S')
t8_2 = dt.datetime.strptime('2019-10-14 13:10:30', '%Y-%m-%d %H:%M:%S')

'''
10-5	4pm-5:37pm, 9:30pm-11pm
10-8	3:20pm-6pm
10-9	2pm-6pm
10-11	11:05am-2pm, 2:55pm-6:00pm
10-14	10:30am – 11:00am, 11:40am-2pm
'''
...
def get_time_slice(startTime, endTime):
    temp1 = []
    for result in perdelta(startTime, endTime, dt.timedelta(minutes=170)):
        temp1.append(result)
...
def clean_time_slice(startTime, endTime):
    ...
    if (next_time - previous_time) < dt.timedelta(minutes=10):
        del temp_slice_list[-2]
    return temp_slice_list

temp_slice1 = clean_time_slice(t1_1, t1_2)
...
time_slice=[temp_slice1,temp_slice2,temp_slice3,temp_slice4,temp_slice5,
            temp_slice6,temp_slice7,temp_slice8]
#-----------------------------------------------------------------------------  
# Store the cleaned actigraph data for 'single person time'
wrist_path = os.listdir(r'D:/YangTrial/All/30s/wrist/') # returns a list under the path
pedometer_path = os.listdir(r'D:/YangTrial/All/30s/pedometer/') # returns a list under the path

wrist_path_list=[]
for each in wrist_path:
    path = 'D:/YangTrial/All/30s/wrist/'+each
    wrist_path_list.append(path)

pedo_path_list=[]
for each in pedometer_path:
    path = 'D:/YangTrial/All/30s/pedometer/'+each
...
wrist_day1 = get_acti_steps(wrist_path_list[0],t1_1,t1_2)
...
wrist_data = [wrist_day1, wrist_day2, wrist_day3, wrist_day4, wrist_day5, wrist_day6, 
              wrist_day7, wrist_day8]

pedometer_day1 = get_acti_steps(pedo_path_list[0],t1_1,t1_2)
...
pedometer_data = [pedometer_day1, pedometer_day2, pedometer_day3, pedometer_day4, 
...
MotionData_day1 = MotionData[(MotionData['local_timestamp'] >= t1_1) & (MotionData['local_timestamp'] <= t1_2) ]
...
Motion_data_list = [MotionData_day1, MotionData_day2, MotionData_day3, MotionData_day4, 
